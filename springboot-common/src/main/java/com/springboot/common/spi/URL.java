...
import com.springboot.common.spi.util.CommonUtil;
import com.springboot.common.spi.util.NetUtils;
...
import static com.springboot.common.spi.CommonConstants.*;
...
public class URL implements Serializable {
    ...
    public URL(String protocol, String host, int port, String[] pairs) { // varargs ... conflict with the following path argument, use array instead.
        this(protocol, null, null, host, port, null, CommonUtil.toStringMap(pairs));
    }
    ...
    public URL(String protocol, String host, int port, String path, String... pairs) {
        this(protocol, null, null, host, port, path, CommonUtil.toStringMap(pairs));
    }
    ...
    public URL(String protocol, String username, String password, String host, int port, String path, String... pairs) {
        this(protocol, username, password, host, port, path, CommonUtil.toStringMap(pairs));
    }
    ...
    public static Map<String, Map<String, String>> toMethodParameters(Map<String, String> parameters) {
        ...
        if (StringUtils.isNotEmpty(methodsString)) {
            List<String> methods = CommonUtil.splitToList(methodsString, ',');
    ...
    public <T> T getParameter(String key, Class<T> valueType, T defaultValue) {
        ...
        if (StringUtils.isNotBlank(value)) {
            result = JSON.parseObject(key, valueType);
        }
        if (result == null) {
            result = defaultValue;
        }
    ...
    public URL addParameters(String... pairs) {
        ...
        return addParameters(CommonUtil.toStringMap(pairs));
    }
    ...
    public URL addParameterString(String query) {
        ...
        return addParameters(CommonUtil.parseQueryString(query));
    }
