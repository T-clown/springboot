...
public class LogAspect {
    ...
    //
    //}
    @Pointcut("@annotation(com.springboot.common.aop.annotation.PrintLog)")
    public void pointcut() {
    ...
    public Object around(ProceedingJoinPoint point, PrintLog printLog) throws Throwable {
        log.info("环绕通知，执行之前,{}", printLog.description());
        ...
        log.info("{},{},{},{},{},{}", JSON.toJSONString(args), kind, aClass.getName(), target,aThis, method.getName());
