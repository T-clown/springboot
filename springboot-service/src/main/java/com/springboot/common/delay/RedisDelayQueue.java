...
/**
 * 来源:git@github.com:pengxincheng/redisson-delayed-queue-demo.git
 * https://github.com/pengxincheng/redisson-delayed-queue-demo.git
 * https://juejin.cn/post/7147248986716373022
 * rediss 延时队列操作类
 */
@Component
@Slf4j
...
//    }
    RDelayedQueue<String> getDelayQueue(String queueName) {
        return delayedQueueMap.computeIfAbsent(queueName, k -> {
            RBlockingQueue<String> blockingQueue = getBlockingQueue(queueName);
            return redissonClient.getDelayedQueue(blockingQueue);
        });
    }
